<div>
    <nav class="navbar-landingpage">
        <ul class="ul-navbar-landingpage">
            <li class="li-navbar-landingpage">
                    ...
                    <svg width="30px" height="30px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g data-name="Layer 11" id="Layer_11">
                                <path class="cls-1"
                                    d="M30.71,15.29l-14-14a1,1,0,0,0-1.42,0l-14,14a1,1,0,0,0-.21,1.09A1,1,0,0,0,2,17H5V30a1,1,0,0,0,1,1h8a1,1,0,0,0,1-1V24h2v6a1,1,0,0,0,1,1h8a1,1,0,0,0,1-1V17h3a1,1,0,0,0,.92-.62A1,1,0,0,0,30.71,15.29Z">
                                </path>
                            </g>
                        </g>
                    </svg>
            ...
            <li class="li-navbar-landingpage">
                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path
                            d="M3 10C3 9.44772 3.44772 9 4 9H10V20C10 20.5523 9.55228 21 9 21H4C3.44772 21 3 20.5523 3 20V10Z"
                            stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M13 15C13 13.3431 14.3431 12 16 12H18C19.6569 12 21 13.3431 21 15V21H13V15Z"
                            stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <rect x="15" y="9" width="4" height="3" stroke="#000000" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"></rect>
                        <rect x="6" y="4" width="4" height="5" stroke="#000000" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"></rect>
                        <path d="M8 4L8 2" stroke="#000000" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M17 9V6" stroke="#000000" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                        <path d="M17 17V12" stroke="#000000" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"></path>
                    </g>
                </svg> Vape Store
            </li>
            <li class="li-navbar-landingpage">
                ...
                <svg fill="#ffffff" height="25px" width="25px" version="1.1" id="Icons"
