    ...
    <div class="section2">
        ...
        <div class="item2-section2">
            <div class="object-hiasan-item2-section2">
                ...
                <img id="slide1" width="100%" src="/image/landingpage/vape-content1 .png" alt=""
                    srcset="">
                <img id="slide2" width="100%" src="/image/landingpage/vape-content1 .png" alt=""
                    srcset="">
                <img id="slide3" width="100%" src="/image/landingpage/vape-content1.jpg" alt=""
                    srcset="">
                <img id="slide4" width="100%" src="/image/landingpage/vape-content1 .png" alt=""
                    srcset="">
            ...
            <div class="hiasan2-item2-section2">

            </div>
            <div class="hiasan3-item2-section2">
